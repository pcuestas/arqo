...
The tests are made using the \emph{scr4\_test.sh} script. We have submitted them to the cluster, in order to make a sufficiently large number of repetitions and be able to get good results by making the means. We have used 6 cores.
...
As we can see, the results of the $\pi$ approximation are the same in all the programs.
