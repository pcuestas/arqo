...
\newcommand{\greyItem}[1]{\item\emph{\textcolor{darkgray}{#1}}\vspace{2.5pt}}
...
%4
\greyItem{Fill in a table with time and speedup results compared to the serial version for images of different resolutions (SD, HD, FHD, UHD-4k, UHD-8k). You must include a column with the fps at which the program would process}\label{question:5.4}
