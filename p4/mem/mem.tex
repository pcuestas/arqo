...
\begin{figure}[htbp]
    \centering
    \subfigure[]{\includegraphics[width=0.24\textwidth]{../material/img/im4.jpg}} 
    \subfigure[]{\includegraphics[width=0.24\textwidth]{../material/img/im4_grey.jpg}} 
...
\begin{figure}[h!]
    \centering
    \subfigure[]{\includegraphics[width=0.24\textwidth]{../material/img/ejex.jpg}} 
    \subfigure[]{\includegraphics[width=0.24\textwidth]{../material/img/ejey.jpg}} 
    \subfigure[]{\includegraphics[width=0.24\textwidth]{../material/img/eje.jpg}}
...
For obtaining the results of this exercise, we have run \emph{scr5.sh}.
...
\lstinputlisting[language=BASH]{tables/output_unroll}

On the other hand, the optimizations related to vectorization are the following:

\lstinputlisting[language=BASH]{tables/output_vector}
